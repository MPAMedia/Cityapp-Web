...
<div class="content-wrapper">
            ...
            <div class="col-sm-6">
                <div class="box box-solid">
                    <div class="box-header">
                        <div class="box-title"><b><?=Translate::sprint("Edit Place")?></b></div>
                    </div>
  ...
  <div class="form-group required">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control"  id="addPlace" type="text" placeholder="<?=Translate::sprint("Enter")?> ..."
                                   value="<?=$dataToEdit['name']?>"/>
                        </div>
                          
                        <div class="form-group">
                            <label><?=Translate::sprint("Place Ar Name ")?> <sup>*</sup> </label>
                            <input class="form-control"  id="addPlaceAr" type="text" placeholder="<?=Translate::sprint("أدخل")?> ..."
                                   value="<?=$dataToEdit['name_ar']?>"/>
                        </div>
                          
                        <div class="form-group">
                            <label><?=Translate::sprint("Place Latitude ")?> <sup>*</sup> </label>
                            <input class="form-control"  id="addPlaceLatitude" type="text" placeholder="<?=Translate::sprint("54.4544")?> ..."
                                   value="<?=$dataToEdit['latitude']?>"/>
                        </div>
                          
                        <div class="form-group">
                            <label><?=Translate::sprint("Place Longitude ")?> <sup>*</sup> </label>
                            <input class="form-control"  id="addLongitude" type="text" placeholder="<?=Translate::sprint("45.687845")?> ..."
                                   value="<?=$dataToEdit['longitude']?>"/>
                        </div>
...
<script>
    ...
    $("#btnEdit").on('click',function(){
        ...
        var name = $("#addPlace").val();
        var name_ar = $("#addPlaceAr").val();
        var latitude = $("#addPlaceLatitude").val();
        var longitude = $("#addLongitude").val();
        

        $.ajax({
            url:"<?=site_url("ajax/place/editPlace")?>",
            data:{
                'name':name,
                'name_ar':name_ar,
                'latitude':latitude,
                'longitude':longitude,
                'place_id':"<?=$dataToEdit['id_place']?>",
                   "image":fileUploaded
            ...
            success: function (data, textStatus, jqXHR) {
                ...
                if(data.success===1){
                    /*alert(data.message);*/
                   document.location.href="<?=admin_url("place/places")?>";
