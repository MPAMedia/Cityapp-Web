...
<div class="content-wrapper">
                    ...
                    <div class="box-body">
                        <form id="form" role="form">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" placeholder="Enter ..." value="<?=$store['name_ar']?>" name="name_ar" id="name_ar" disabled>
  ...
  <!-- textarea -->
                            <div class="form-group">
                                ...
                                <textarea id="" class="form-control" style="height: 300px" disabled><?php echo strip_tags($store['detail_ar']); ?></textarea>
                            </div>
