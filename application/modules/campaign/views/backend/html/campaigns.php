            ...
            <table id="example2" class="table table-bordered table-hover">
                ...
                <?php  if(count($list)){ ?>
                    <?php foreach ($list as $campaign) { ?>
                            ...
                            <td>
                                <?php
                                    ...
                                    if($campaign['status']==-1){
                                        ...
                                        echo '<span class="badge bg-yellow"  data-toggle="tooltip" title="'.Translate::sprint("Pending").'"> <i class="mdi mdi-history"></i> &nbsp;'?> <?=Translate::sprint("Pending","")?>  <?php echo '&nbsp;&nbsp;</span>';
                        ...
                        <?php if($this->mUserBrowser->getData("typeAuth") =="admin" and $campaign['status']==-1)  {?>
                                <a class="text-blue" href="<?=admin_url("campaign/campaigns?push=".$campaign['id'])?>"  data-toggle="tooltip" title="<?=Translate::sprint("Push","")?>">
                                    <i class=" fa fa-paper-plane"></i>&nbsp;&nbsp;&nbsp;
                                </a>
                            <a href="#" id="delete-<?=$campaign['id']?>"  data-toggle="tooltip" title="<?=Translate::sprint("Delete","")?>">
                                    <span class="glyphicon glyphicon-trash"></span>&nbsp;&nbsp;
                            </a>
                            <?php }else{ ?>

                            <?php if($this->mUserBrowser->getData("id_user")==$campaign['user_id']){ ?>
                                <a href="<?=site_url('ajax/campaign/archiveCampaign?id='.$campaign['id'])?>" class="linkAccess"  onclick="return false;"  data-toggle="tooltip" title="<?=Translate::sprint("Archive","")?>">
                                    <span class="glyphicon glyphicon-save"></span>&nbsp;&nbsp;
                                </a>
                                <a href="<?=site_url('ajax/campaign/duplicateCampaign?id='.$campaign['id'])?>" title="<?=Translate::sprint("Duplicate","")?> "  class="linkAccess"  onclick="return false;"  data-toggle="tooltip" title="<?=Translate::sprint("Duplicate")?>">
