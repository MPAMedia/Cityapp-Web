      ...
      <div class="login-box-body">
        ...
        <form id="form" method="post">
          ...
          <div class="row">
            ...
            <div class="col-xs-5">
                <button type="submit"  class="btn btn-primary btn-block btn-flat resetP"><?=Translate::sprint("Reset","")?></button>
            </div><!-- /.col -->
          </div>
        </form>
                    ...
                    $.ajax({
                        ...
                        success: function (data, textStatus, jqXHR) {
                          ...
                          console.log(data);
                            ...
                            $("#form .resetP").attr("disabled",false);
                            if(data.success===1){
                                document.location.href = "<?=admin_url("user/login")?>";
