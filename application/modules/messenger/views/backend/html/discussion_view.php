...
<tr <?php if($nbrMessageNotSeen>0){ echo "class='active'";} ?>>
    <td>
        ...
        <div class="discussion-content">
            ...
            if($sender['typeAuth'] == "manager") {
                echo '<span class="pull-right badge bg-blue">'.Translate::sprint("Owner","").'</span>';
            } else if ($sender['typeAuth'] == "admin") {
                echo '<span class="pull-right badge bg-green">'.Translate::sprint("Admin","").'</span>';
            }else if ($sender['typeAuth'] == "customer") {
                echo '<span class="pull-right badge bg-yellow">'.Translate::sprint("Customer","").'</span>';
            }
