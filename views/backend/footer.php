      ...
      <footer class="main-footer">
        ...
        <!-- Default to the left -->
        <strong>Copyright &copy; <?=date("Y")?> <a style="text-transform: uppercase" href="<?=site_url("")?>"><?=APP_NAME?></a>.</strong> <?=Translate::sprint("All rights reserved.")?>
      ...
      <script>
          ...
          $("#editable-textarea").wysihtml5({
              ...
              "link": false,
                    ...
                    $("#editable-textarea_ar").wysihtml5({
              "image": false,
              "link": false,
          });
