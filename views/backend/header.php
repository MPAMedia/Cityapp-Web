...
<html>
  <head>
    ...
    <link rel="stylesheet" href="<?=  base_url("views/skin/backend/plugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.min.css")?>">
  ...
  <link rel="stylesheet" href="<?=base_url("views/skin/backend/plugins/datatables/dataTables.bootstrap.css")?>">
    ...
    <link rel="stylesheet" href="<?=  base_url("views/skin/backend/plugins/minified/themes/default.min.css")?>" type="text/css" media="all" />



    <link rel="stylesheet" href="<?=  base_url("views/skin/backend/plugins/datatables/jquery.dataTables.min.css")?>" type="text/css" media="all" />
        ...
        <nav class="navbar navbar-static-top" role="navigation">
          ...
          <div class="navbar-custom-menu">
            <ul class="nav navbar-nav">
              ...
              <?php if(DEMO==TRUE): ?>
              <li class=" messages-menu bg-red">
                <a STYLE="color: #ffffff" href="https://codecanyon.net/item/nearbystores-offers-events-chat-realtime/21251567?ref=DroideveTechnology">
              ...
              <?php if($this->mUserBrowser->getData("typeAuth") =="admin" and $this->uri->segment(2)!="campaigns")  {?>
              <?php
             ...
             <?php } ?>
              ...
              <li class="dropdown notifications-menu">
                <a href="#"  class="dropdown-toggle" data-toggle="dropdown" aria-expanded="true">
                  <i class="mdi mdi-flag"></i> &nbsp;<?=Translate::sprint("Language","")?>: <?=$langName?>
                </a>
                ...
                <ul class="dropdown-menu">
                 <!-- <li class="header"><?/*=Translate::sprint("Role Type","")*/?> : <?/*=$this->mUserBrowser->getAdmin("typeAuth")*/?></li>-->
                  <li>
                    ...
                    <ul class="menu">
                      <li>
                        <a href="<?=  admin_url("user/edit")?>"><i class="fa fa-pencil"></i>&nbsp;&nbsp;<?=Translate::sprint("Profile","")?> </a>
                      </li>
                      <li>
                        <a href="<?=  admin_url("user/logout")?>"><i class="fa fa-sign-out"></i>&nbsp;&nbsp;<?=Translate::sprint("Logout","")?> </a>
                      </li>
                    </ul>
                  </li>
                </ul>
