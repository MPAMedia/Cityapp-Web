...
<head>
    ...
    <link rel="stylesheet" href="<?=  base_url("views/skin/backend/dist/css/skins/skin-blue.min.css")?>">
...
<body class="hold-transition login-page"  dir="<?=__DIR?>">
<div class="login-box">
    <div class="login-logo">
        <?php
        $imageUrl = base_url("views/skin/backend/images/logo.png");
            $images = _openDir(APP_LOGO);

        if(!empty($images)){
            $imageUrl = $images['200_200']['url'];
        }

        ?>
        <img style="max-height: 150px;" src="<?= $imageUrl ?>">
    </div><!-- /.login-logo -->