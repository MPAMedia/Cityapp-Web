        ...
        <div class="container">
            <div class="mu-header-area">
                ...
                <div class="mu-logo-area">
                    ...
                    <u class="menu">
                        <li><a class="active" href="https://play.google.com/store/apps/details?id=com.bhome.android.madinatyapp">Google Play</a></li>
                        <?php if($this->mUserBrowser->isLogged()): ?>
                            <li><a href="<?=admin_url("")?>">Dashboard</a></li>
                        <?php else: ?>
                            <li><a href="<?=admin_url("user/login")?>">LOG IN</a></li>
                        <?php endif;?>

<!--                        <li><a href="#mu-faq">FAQ</a></li>-->
                        <li><a href="https://play.google.com/store/apps/details?id=com.bhome.android.madinatyapp" >Download</a></li>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6  mu-header-featured-content">
                            ...
                            <div class="mu-app-download-area">
                                ...
                                <a class="mu-google-btn" target="_blank" href="https://play.google.com/store/apps/details?id=com.bhome.android.madinatyapp"><i class="fa fa-android"></i><span>google play</span></a>
...
<div class="mu-menu-full-overlay">
    <div class="mu-menu-full-overlay-inner">
        ...
        <nav class="mu-menu" role="navigation">
            <ul>
                <?php if(DEMO==TRUE): ?>
                <li><a class="active" href="#" onclick="redirect('https://play.google.com/store/apps/details?id=com.bhome.android.madinatyapp')">Play Now</a></li>
                <?php endif;?>
                <?php if($this->mUserBrowser->isLogged()): ?>
                ...
                <!--                        <li><a href="#mu-faq">FAQ</a></li>-->
                <li><a href="#"  onclick="redirect('https://play.google.com/store/apps/details?id=com.bhome.android.madinatyapp')" >Download</a></li>
                <li><a href="#mu-apps-screenshot">Screenshots </a></li>
                <li><a href="#mu-feature">Features</a></li>
            </ul>
        </nav>
