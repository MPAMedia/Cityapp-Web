...
<footer id="mu-footer" role="contentinfo">
    <div class="container">
        <div class="mu-footer-area">
            <p class="mu-copy-right">&copy; Copyright <a rel="nofollow" href="http://bhome-media.com">B Network</a>. All right reserved. Template Designed  by <a  target="_blank" rel="nofollow" href="http://bhome-media.com">B Home Media</a></p>
        </div>
    </div>
